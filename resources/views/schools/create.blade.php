...
@section('content')
    <div class="form-wrapper d-flex flex-column justify-content-center align-items-center">
        <div class="form-card card shadow-lg p-5 w-100" style="max-width: 600px;">
            ...
            <form method="POST" action="{{ route('schools.store') }}" enctype="multipart/form-data" id="schoolForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control form-control-lg" id="address" name="address" required maxlength="255" value="{{ old('address') }}">
                </div>

                {{-- Correu electrònic --}}
                <div class="mb-4">
                    <label for="email" class="form-label">Correu electrònic</label>
                    <input type="email" class="form-control form-control-lg" id="email" name="email" maxlength="255" value="{{ old('email') }}">
                </div>

                {{-- Telèfon --}}
                <div class="mb-4">
                    <label for="phone" class="form-label">Telèfon</label>
                    <input type="text" class="form-control form-control-lg" id="phone" name="phone" maxlength="20" value="{{ old('phone') }}">
                </div>

                {{-- Web --}}
                <div class="mb-4">
                    <label for="website" class="form-label">Web</label>
                    <input type="text" class="form-control form-control-lg" id="website" name="website" maxlength="255" value="{{ old('website') }}">
                </div>
        ...
        <div class="fixed-buttons">
            ...
            <button type="submit" form="schoolForm" class="btn btn-success btn-lg">Crear escola</button>
        </div>
    </div>
@endsection
